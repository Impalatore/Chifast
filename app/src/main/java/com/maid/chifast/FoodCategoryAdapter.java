...
public class FoodCategoryAdapter extends RecyclerView.Adapter<FoodCategoryAdapter.CategoryHolder> {
    ...
    public void onBindViewHolder(@NonNull CategoryHolder holder, int position) {
        ...
        if (position == selectedItem){
            ...
            holder.titulo.setTextColor(context.getColor(R.color.red));
            holder.imagen.setColorFilter(ContextCompat.getColor(context,R.color.red), PorterDuff.Mode.SRC_IN);
        }else {
            // Make card inactive
            ...
            holder.titulo.setTextColor(context.getColor(R.color.gray));
            holder.imagen.setColorFilter(ContextCompat.getColor(context,R.color.gray1), PorterDuff.Mode.SRC_IN);
    ...
    class CategoryHolder extends RecyclerView.ViewHolder{
        ...
        public CategoryHolder(View holder){
            super(holder);
            titulo = holder.findViewById(R.id.txt_title);
            imagen = holder.findViewById(R.id.img);
