...
public class MainActivity extends AppCompatActivity {
    ...
    private void setCategories() {
        ...
        FoodCategory foodCategory = new FoodCategory("Sopas",R.drawable.ic_burger);
        FoodCategory foodCategory2 = new FoodCategory("Chaufas",R.drawable.ic_chicken);
        FoodCategory foodCategory3 = new FoodCategory("Tallarines",R.drawable.ic_pizza);
        FoodCategory foodCategory4 = new FoodCategory("Adicionales",R.drawable.ic_chicken);
